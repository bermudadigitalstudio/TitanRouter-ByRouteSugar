...
extension Titan {
  ...
  public func trace(path: String, handler: @escaping Function) {
    route(method: "TRACE", path: path, handler: handler)
  }

  public func connect(path: String, handler: @escaping Function) {
    route(method: "CONNECT", path: path, handler: handler)
  }
